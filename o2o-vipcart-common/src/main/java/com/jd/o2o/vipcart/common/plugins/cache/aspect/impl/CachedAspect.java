 ...
 */
@Aspect
public final class CachedAspect {
    ...
    public CachedAspect(boolean allowNullValues, final Cache cache) {
     ...
     * @throws Throwable
     */
    @Around("execution(* *(..)) && @annotation(com.jd.o2o.vipcart.common.plugins.cache.aspect.Cached)")
    ...
    private void writeCache(final ProceedingJoinPoint point, final Object key, Object obj) {
        ...
        try {
            ...
            final Cached annot = method.getAnnotation(Cached.class);
            if (isUseCache(annot, obj)) {
                final boolean sync = annot.sync();
                if (sync) {
                    putCache(key, obj, method, annot);
                } else {
     ...
     * @param annot
     */
    private void putCache(Object key, Object value, Method method, Cached annot) {
        try {
            // 计算缓存时间
     ...
     * @return
     */
    private int getLifeTime(Cached annot) {
        int lifeTime;
        if (annot.forever()) {
     ...
     * @return
     */
    private boolean isUseCache(Cached annot, Object result) {
