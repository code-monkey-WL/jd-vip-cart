...
public final class SoftHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V> {
    ...
    private abstract class HashIterator<T> implements Iterator<T> {
        int index;
        SoftHashMap.Entry<K, V> entry = null;
        SoftHashMap.Entry<K, V> lastReturned = null;
        ...
        public boolean hasNext() {
            SoftHashMap.Entry<K, V>[] t = table;
            while (nextKey == null) {
                SoftHashMap.Entry<K, V> e = entry;
                int i = index;
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            if (!(o instanceof Map.Entry)) return false;
            Map.Entry e = (Map.Entry) o;
            SoftHashMap.Entry candidate = getEntry(e.getKey());
        ...
        public Object[] toArray() {
            ...
            for (Iterator<Map.Entry<K, V>> i = iterator(); i.hasNext(); )
                c.add(new SoftHashMap.SimpleEntry<K, V>(i.next()));
            return c.toArray();
        }
